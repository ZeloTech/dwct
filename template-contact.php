	            ...
	            <?php } else { ?>
	                ...
	                <form action="<?php the_permalink(); ?>" id="contact-form" method="post">
	                    <div class="contact-form">
	                        <p><label for="contactName"><?php _e('Name:', 'junkie') ?></label>
	                        ...
	                        <p><label for="email"><?php _e('Email:', 'junkie') ?></label>
	                        ...
	                        <p class="textarea"><label for="commentsText"><?php _e('Message:', 'junkie') ?></label>
